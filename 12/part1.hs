...
solve :: Grid -> [Int]
solve g = foldr (\regionPrices c -> price (floodFill g [] c) : regionPrices) [] (indices g)

-- i need the flood fill approach to get the area of each region ...
...
floodFill :: Grid -> [Coord] -> Coord -> Section
